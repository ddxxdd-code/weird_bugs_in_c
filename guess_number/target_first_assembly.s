...
guess_number[0x100003e14] <+4>:   subq   $0x40, %rsp
...
guess_number[0x100003e3b] <+43>:  leaq   -0x14(%rbp), %rsi
guess_number[0x100003e3f] <+47>:  movl   %eax, -0x24(%rbp)
guess_number[0x100003e42] <+50>:  movb   $0x0, %al
guess_number[0x100003e44] <+52>:  callq  0x100003f0e               ; symbol stub for: scanf
guess_number[0x100003e49] <+57>:  movl   -0x14(%rbp), %esi
guess_number[0x100003e4c] <+60>:  leaq   0x102(%rip), %rdi         ; "target: %d\n"
guess_number[0x100003e53] <+67>:  movl   %eax, -0x28(%rbp)
...
guess_number[0x100003ec3] <+179>: movl   %eax, -0x40(%rbp)
guess_number[0x100003ec6] <+182>: movl   %ecx, %eax
guess_number[0x100003ec8] <+184>: addq   $0x40, %rsp
